...
public:
        static constexpr char default_rgba_atlas_file[] = "../resource/font/gsanscode_w300_mtsdf.rgba";
        static constexpr char default_csv_mapping_file[] = "../resource/font/gsanscode_w300.csv";
